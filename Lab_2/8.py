...
scroll_w = 30
scroll_h = 3
scrolled_text = scrolledtext.ScrolledText(win, width=scroll_w, height=scroll_h, wrap=tk.WORD)
scrolled_text.grid(column=0, row=2, padx=10, pady=10, sticky='W')
...
buttons_frame = ttk.LabelFrame(win, text='Labels in a Frame', padding=(10, 10))
buttons_frame.grid(column=0, row=5, columnspan=3, padx=10, pady=10)
